...
sbr_block_builder *sbr_block_from_inline(sbr_layout_context *, sbr_inline *,
                                         sbr_computed_style *);
...
void sbr_span_builder_append_text(sbr_span_builder *, char const *text,
                                  size_t text_len);
...
sbr_vec2l sbr_inline_measure(sbr_inline *, sbr_layout_pass *,
                             sbr_vec2l available_size);
sbr_fragment *sbr_inline_layout(sbr_inline *, sbr_layout_pass *,
                                sbr_vec2l available_size);
