...
pub struct WindowPos {
    ...
    pub x: u32,
    pub y: u32,
    // Row count and column count appear to be used by autogenerated subtitles.
    // I believe they are responsible for setting `min-width`/`min-height` properties on
    // windows? Seems like the measurement for cc is done by checking the width of "-" * cc.
    // Not exactly sure how they affect rendering.
    // TODO: Figure out row count and column count
