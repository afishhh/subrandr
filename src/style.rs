...
// Generates `ComputedStyle` for all properties along with `ComputedStyle`.
//
...
macros::implement_style_module! {
    rc font {
        #[copy(no)] font_family: [util::rc::Rc<str>] = rc_static!([rc_static!(str b"serif")]),
        font_weight: I16Dot16 = I16Dot16::new(400),
        font_size: I26Dot6 = I26Dot6::new(16),
        font_slant: FontSlant = computed::FontSlant::Regular,
    }
