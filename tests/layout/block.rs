...
use crate::{
    layout::FixedL,
    style::computed::{Direction, HorizontalAlignment, Length},
};
...
test_define_style! {
    ...
    .tmargin10 { margin_top: Some(Length::from_pixels(FixedL::new(10))) }
    .bmargin16 { margin_bottom: Some(Length::from_pixels(FixedL::new(16))) }
    .bmargin10 { margin_bottom: Some(Length::from_pixels(FixedL::new(10))) }
...
check_test! {
    ...
    block.ahem.black_on_white {
        ...
        block.lmargin10.rmargin16.tmargin10.bmargin16.lpadding6.vpadding4.red_bg {
            inline { text "BBBB" }
        }
        ...
        block.width64.lmargin10.rmargin_auto.bmargin10.green_bg {
            inline { text "CCCC" }
        }
