...
fn bindgen_test_layout__FcMatrix() {
    const UNINIT: ::std::mem::MaybeUninit<_FcMatrix> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout__FcObjectType() {
    const UNINIT: ::std::mem::MaybeUninit<_FcObjectType> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout__FcConstant() {
    const UNINIT: ::std::mem::MaybeUninit<_FcConstant> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout__FcPatternIter() {
    const UNINIT: ::std::mem::MaybeUninit<_FcPatternIter> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout__FcValue__bindgen_ty_1() {
    const UNINIT: ::std::mem::MaybeUninit<_FcValue__bindgen_ty_1> =
...
fn bindgen_test_layout__FcValue() {
    const UNINIT: ::std::mem::MaybeUninit<_FcValue> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout__FcFontSet() {
    const UNINIT: ::std::mem::MaybeUninit<_FcFontSet> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).nfont) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).sfont) as usize - ptr as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(_FcFontSet),
...
fn bindgen_test_layout__FcObjectSet() {
    const UNINIT: ::std::mem::MaybeUninit<_FcObjectSet> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).nobject) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).sobject) as usize - ptr as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(_FcObjectSet),
...
fn bindgen_test_layout__FcConfigFileInfoIter() {
    const UNINIT: ::std::mem::MaybeUninit<_FcConfigFileInfoIter> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
